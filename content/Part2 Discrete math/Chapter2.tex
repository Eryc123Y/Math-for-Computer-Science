...
\section{Primes and Greatest Common Divisors}
    ...
    \subsubsection*{Greatest Common Divisors as Linear Combinations}
        ...
        \begin{proof}
            ...
            combination of $a$ and $b$. Since $r_{n+1}$ is the last nonzero remainder in the division process, it is the greatest common divisor of $a$ and $b$,which proves Bézout's identity. $\square$
        \end{proof}
